...
<div class="col-md-12 col-sm-12 col-xs-12">
	<div class="x_panel">
		<div class="x_title">
			<h2>{!! trans('labels.county') !!} <small>{!! trans('labels.create') !!}</small></h2>
		...
		<div class="x_content">
			...
			{!! Form::open(['route' => 'admin.county.store', 'id' => 'frmCreateCounty', 'class' => 'form-horizontal form-label-left'] ) !!}
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					{!! Form::select('city_id', $cities, null, ['class' => 'form-control col-md-7 col-xs-12']) !!}
				</div>
			</div>
...
@endsection
@section('script')
{!! JsValidator::formRequest('App\Http\Requests\Backend\CountyRequest', '#frmCreateCounty'); !!}
@endsection
