...
@section('content')
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>{!! trans('labels.category') !!}<small>{!! trans('labels.edit') !!}</small></h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <br />
                {!! Form::open(['route' => ['admin.category.update', $category->id], 'method' => 'put', 'id' => 'frmCreateCategory', 'class' => 'form-horizontal form-label-left']) !!}
